...
import { NpmPackageInspectorTool } from "@/components/pages/developer-tools/NpmPackageInspectorTool";

export function NpmPackageInspectorPageClient() {
