...
import { WpGitignoreGeneratorTool } from "@/components/pages/developer-tools/WpGitignoreGeneratorTool";

export function WpGitignoreGeneratorPageClient() {
