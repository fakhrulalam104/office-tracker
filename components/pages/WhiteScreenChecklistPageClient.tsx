...
import { WhiteScreenChecklistTool } from "@/components/pages/developer-tools/WhiteScreenChecklistTool";
export function WhiteScreenChecklistPageClient() {
