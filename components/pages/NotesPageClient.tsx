...
function RichToolbar({ editorRef }: { editorRef: React.RefObject<HTMLDivElement | null> }) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-0.5 rounded-2xl border border-slate-200 bg-white px-2 py-1.5">
      ...
      <ToolbarDivider />
      <ToolbarButton onClick={() => execCmd("bold")} title="Bold"><span className="font-bold">B</span></ToolbarButton>
      <ToolbarButton onClick={() => execCmd("italic")} title="Italic"><span className="italic">I</span></ToolbarButton>
      <ToolbarButton onClick={() => execCmd("underline")} title="Underline"><span className="underline">U</span></ToolbarButton>
      <ToolbarButton onClick={() => execCmd("strikeThrough")} title="Strikethrough"><span className="line-through">S</span></ToolbarButton>

      <ToolbarDivider />
      <ToolbarButton onClick={() => execCmd("subscript")} title="Subscript"><span className="text-[10px]">X<sub>2</sub></span></ToolbarButton>
      <ToolbarButton onClick={() => execCmd("superscript")} title="Superscript"><span className="text-[10px]">X<sup>2</sup></span></ToolbarButton>
      ...
      <div className="relative">
        <label title="Font color" className="flex items-center cursor-pointer rounded-lg px-2 py-1 text-slate-600 hover:bg-slate-100">
          <span className="text-xs font-bold border-b-2" style={{ borderColor: fontColor }}>A</span>
      ...
      <div className="relative">
        <label title="Highlight" className="flex items-center cursor-pointer rounded-lg px-2 py-1 text-slate-600 hover:bg-slate-100">
          <span className="text-xs font-bold rounded px-0.5" style={{ backgroundColor: highlightColor }}>ab</span>
      ...
      <ToolbarButton onClick={() => execCmd("justifyLeft")} title="Align left">
        <span className="text-[10px] leading-tight block w-4 text-left">≡</span>
      </ToolbarButton>
      <ToolbarButton onClick={() => execCmd("justifyCenter")} title="Align center">
        <span className="text-[10px] leading-tight block w-4 text-center">≡</span>
      </ToolbarButton>
      <ToolbarButton onClick={() => execCmd("justifyRight")} title="Align right">
        <span className="text-[10px] leading-tight block w-4 text-right">≡</span>
      </ToolbarButton>
  ...
  return (
    <div className="flex flex-wrap items-center gap-0.5 rounded-2xl border border-slate-200 bg-white px-2 py-1.5 mt-2">
      ...
      <ToolbarButton onClick={() => execCmd("smallCaps")} title="Small Caps">
        <span className="text-[10px] font-semibold tracking-tight">Sc</span>
      </ToolbarButton>
