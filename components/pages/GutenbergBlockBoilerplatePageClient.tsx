...
import { GutenbergBlockBoilerplateTool } from "@/components/pages/developer-tools/GutenbergBlockBoilerplateTool";

export function GutenbergBlockBoilerplatePageClient() {
