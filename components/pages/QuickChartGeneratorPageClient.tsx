...
import { QuickChartGeneratorTool } from "@/components/pages/developer-tools/QuickChartGeneratorTool";

export function QuickChartGeneratorPageClient() {
