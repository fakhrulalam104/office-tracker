...
import { SerializedPhpReplaceTool } from "@/components/pages/developer-tools/SerializedPhpReplaceTool";

export function SerializedPhpReplacePageClient() {
