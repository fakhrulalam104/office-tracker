...
import { CurlCommandBuilderTool } from "@/components/pages/developer-tools/CurlCommandBuilderTool";

export function CurlCommandBuilderPageClient() {
