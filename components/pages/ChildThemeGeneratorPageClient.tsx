...
import { ChildThemeGeneratorTool } from "@/components/pages/developer-tools/ChildThemeGeneratorTool";

export function ChildThemeGeneratorPageClient() {
