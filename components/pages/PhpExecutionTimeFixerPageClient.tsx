...
import { PhpExecutionTimeFixerTool } from "@/components/pages/developer-tools/PhpExecutionTimeFixerTool";
export function PhpExecutionTimeFixerPageClient() {
