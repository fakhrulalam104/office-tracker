...
import { PluginThemeHeaderGeneratorTool } from "@/components/pages/developer-tools/PluginThemeHeaderGeneratorTool";

export function PluginThemeHeaderGeneratorPageClient() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 px-4 py-6 lg:px-8">
      <div className="mx-auto max-w-7xl space-y-5">
        ...
        <PluginThemeHeaderGeneratorTool />
      </div>
    </div>
  );
}